          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  <div key={item.id} className="flex items-center gap-6 bg-card p-4 rounded-lg border border-border">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center border border-border rounded-md">
                        <button className="p-2 hover:bg-muted transition-colors"><Minus size={16} /></button>
                        <span className="px-4 text-lg">{item.quantity}</span>
                        <button className="p-2 hover:bg-muted transition-colors"><Plus size={16} /></button>
                      </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-card p-8 rounded-lg border border-border sticky top-28">
                ...
                <button className="w-full mt-8 bg-primary text-primary-foreground py-3 rounded-full font-semibold hover:bg-primary/90 transition-all text-lg">
                  Proceed to Checkout
                </button>
