...
import { Phone, MapPin, Heart, Sparkles, ShoppingBag, Sun, Moon, ArrowUpRight } from 'lucide-react';
...
export default function FarahOriginInteractiveBoutique() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-700 antialiased relative overflow-x-hidden ${
    ...
    >
      ...
      <div
        className={`absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full blur-[150px] pointer-events-none opacity-40 transition-colors duration-700 ${
      ...
      <div
        className={`w-full py-2.5 text-center text-[10px] tracking-[0.25em] uppercase font-bold flex items-center justify-center gap-3 border-b transition-colors duration-500 relative z-50 ${
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-24 flex items-center justify-between">
          <div className="flex flex-col group cursor-pointer">
            <span className={`${greatVibes.className} text-4xl text-[#E27D86] font-medium leading-none transition-transform duration-300 group-hover:scale-105`}>
              Farah Origin
            </span>
      ...
      <header id="home" className="max-w-7xl mx-auto px-6 md:px-12 pt-12 pb-24 grid grid-cols-1 md:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="md:col-span-5 relative flex justify-center">
          <div
            className={`p-8 w-full max-w-sm rounded-[32px] border transition-all duration-500 shadow-2xl relative overflow-hidden group hover:shadow-[#E27D86]/10 hover:border-[#E27D86]/40 ${
          ...
          >
            <div className="border border-neutral-200 dark:border-neutral-800 p-6 space-y-8 relative z-10">
              <div className="text-center space-y-1">
                ...
                <h3 className={`${playfair.className} text-3xl font-bold tracking-tight transition-colors duration-300 group-hover:text-[#E27D86]`}>
                  Farah Origin
                </h3>
              </div>
      ...
      <section id="contact" className="max-w-7xl mx-auto px-6 md:px-12 py-24">
        <div
          className={`p-8 md:p-16 border text-center transition-all duration-500 relative overflow-hidden rounded-3xl ${
